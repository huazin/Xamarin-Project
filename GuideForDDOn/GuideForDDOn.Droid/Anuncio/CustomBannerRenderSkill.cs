...
[assembly: ExportRenderer(typeof(MyBannerSkill), typeof(CustomBannerRenderSkill))]

namespace GuideForDDOn.Droid
{
    public class CustomBannerRenderSkill : ViewRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.View> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                //ad.AdUnitId = "ca-app-pub-7647930413486761/5805565843";
